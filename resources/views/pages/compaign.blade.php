...
<div class="container-fluid">
              ...
              <div class="row align-items-center">
                ...
                <div class="col-3">
                  <div class="text-center mb-n5">  
                    <img src="https://demos.adminmart.com/premium/bootstrap/modernize-bootstrap/package/dist/images/breadcrumb/ChatBc.png" alt="" class="img-fluid mb-n4">
                  </div>
                </div>
              </div>
            </div>
          ...
          <section class="datatables">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <!-- ---------------------
                                    start Complex headers (rowspan and colspan)
                                ---------------- -->
                            <div class="card">
                                <div class="card-body">
                                    <div class="mb-2">
                                    ...
                                    <p class=" card-subtitle mb-3">
                                        ...
                                        supports <code> colspan</code> and
                                        <code> rowspan</code> in the table's header, assigning the
                                        required order listeners to the TH element suitable for
                                        that column.
                                    </p>
                                    <div class="table-responsive">
                            ...
                            <!-- ---------------------
                                    end Complex headers (rowspan and colspan)
                                ---------------- -->
                        </div>
                    </div>
                    <!-- DOM Positioning -->
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <p class="card-subtitle mb-3">
                                        ...
                                        containers (with an id and / or class) to provide complete
                                        layout flexibility.
                                    </p>
                                    <div class="table-responsive">
                                        <table id="DOM_pos"
                    ...
                    <div class="row">
                        <div class="col-12">
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="mb-2">
                                        <h5 class="mb-0">Alternative Pagination</h5>
                                    </div>
                                    <p class="card-subtitle mb-3">
                                        ...
                                        may wish to customise the options presented to the end
                                        user. This is done through DataTables' extensible
                                        pagination mechanism, the
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <p class="card-subtitle mb-3">
                                        ...
                                        mandatory, it will work just fine with pagination enabled
                                        as well!).
                                    </p>
                                    <div class="table-responsive">
                                        <table id="scroll_ver"
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <p class=" card-subtitle mb-3">
                                        ...
                                        makes use of the CSS3
                                        <code> vh</code> unit in order to dynamically resize the
                                        viewport based on the browser window height. The vh unit
                                        is effectively a percentage of the browser window height.
                                        So the <code> 50vh</code> used in this example is 50% of
                                        the window height. The viewport size will update
                                        dynamically as the window is resized.
                                    </p>
                                    <div class="table-responsive">
                                        <table id="scroll_ver_dynamic_hei"
                                            class="table border table-striped table-bordered display text-nowrap"
                                            style="width: 100%">
                                            <thead>
                                                <!-- start row -->
                    ...
                    <div class="row">
                        <div class="col-12">
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="mb-2">
                                        <h5 class="mb-0">Scroll - Horizontal</h5>
                                    </div>
                                    <p class="card-subtitle mb-3">
                                        ...
                                        <code> scrollX</code> parameter to be whatever you want
                                        the container wrapper's width to be (this should be 100%
                                        in almost all cases with the width being constrained by
                    ...
                    <div class="row">
                        <div class="col-12">
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <p class=" card-subtitle mb-3">
                                        ...
                                        horizontal and vertical scrolling at the same time. Note
                                        also that pagination is enabled in this example, and the
                                        scrolling accounts for this.
                                    </p>
                                    <div class="table-responsive">
                            ...
                            <!-- ---------------------
                                    end Scroll - Vertical &amp; Horizontal
                                ---------------- -->
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-12">
                            <!-- ---------------------
                                    start Language - Comma decimal place
                                ---------------- -->
                            <div class="card">
                                <div class="card-body">
                                    <div class="mb-2">
                            ...
                            <!-- ---------------------
                                    end Language - Comma decimal place
                                ---------------- -->
                        </div>
                    </div>
                    <!-- language options -->
                    <div class="row">
                        <div class="col-12">
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="mb-2">
                                        <h5 class="mb-0">Language Options</h5>
                                    </div>
                                    <p class="card-subtitle mb-3">
                                        Changing the language information displayed by DataTables
                                        is as simple as passing in a <code> language</code> object
