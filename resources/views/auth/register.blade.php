                                ...
                                <form method="POST" action="{{ route('register') }}">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" id="exampleInputtext"
                                            aria-describedby="textHelp" @error('name') is-invalid @enderror" name="name"
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="email" class="form-control" id="exampleInputEmail1" id="email"
                                    ...
                                    <div class="mb-3">
                                        <div class="">
                                            <div class="form-check from-label">
                                    ...
                                    <div class="d-flex align-items-center">
                                        ...
                                        {{-- <button class="text-primary fw-medium ms-2">Sign In</button> --}}
                                    </div>
                                  </form>
                            </div>
                        </div>
